...
TEST_F(ConnectionStringBuilderTest, test_complete_string) {
    ConnectionStringBuilder builder("testDriver", "testServer", 5432);
    ...
    const std::string expected =
        "DRIVER=testDriver;SERVER=testServer;PORT=5432;COMMLOG=1;DEBUG=1;LOGDIR=logs/;RDSLOGTHRESHOLD=0;UID=testUser;PWD=testPwd;DATABASE=testDb;"
...
TEST_F(ConnectionStringBuilderTest, test_only_required_fields) {
    ...
    const std::string expected = "DRIVER=testDriver;SERVER=testServer;PORT=5432;COMMLOG=1;DEBUG=1;LOGDIR=logs/;RDSLOGTHRESHOLD=0;";
    EXPECT_EQ(0, expected.compare(connection_string));
}
...
TEST_F(ConnectionStringBuilderTest, test_some_optional) {
    ...
    const std::string expected("DRIVER=testDriver;SERVER=testServer;PORT=5432;COMMLOG=1;DEBUG=1;LOGDIR=logs/;RDSLOGTHRESHOLD=0;UID=testUser;PWD=testPwd;");
    EXPECT_EQ(0, expected.compare(connection_string));
}
...
TEST_F(ConnectionStringBuilderTest, test_setting_boolean_fields) {
    ...
    const std::string expected(
        "DRIVER=testDriver;SERVER=testServer;PORT=5432;COMMLOG=1;DEBUG=1;LOGDIR=logs/;RDSLOGTHRESHOLD=0;UID=testUser;PWD=testPwd;ENABLECLUSTERFAILOVER=0;LIMITLESSENABLED=0;");
    EXPECT_EQ(0, expected.compare(connection_string));
}
