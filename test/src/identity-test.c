...
int main(int argc, char **argv)
{
	...
	test_identity_col(
		...
		"INSERT INTO pg_temp.tmptable (t) VALUES ('simple')",
		"SELECT * FROM pg_temp.tmptable");
	...
	test_identity_col(
		...
		"INSERT INTO pg_temp.tmptable2 (t) VALUES ('value.with.dots')",
		"SELECT * FROM pg_temp.tmptable2");
	...
	test_identity_col(
		...
		"INSERT INTO pg_temp.\"tmp table\" (t) VALUES ('space in table name')",
		"SELECT * FROM pg_temp.\"tmp table\"");
